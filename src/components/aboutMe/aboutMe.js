          ...
          <Col xs={24} md={12}>
            <div className="little-about-me-paragraph">
              ...
              <p>
                ...
                follow this passion for tech, I decided to change my career path
                and start learning how to code.
              </p>
              <p>
                I have recently completed the School of Code bootcamp to become
                a web developer. I was selected to join 200 (out of 3000) other
                bootcampers at the School of Code full stack web developer
                bootcamp.
              </p>
              <p>
